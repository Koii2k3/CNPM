...
namespace DALL
{
    ...
    public class UserAccessDAL : DataAccessDAL
    {
        ...
        // Get list of user not joining in a task
        public DataTable GetUserOutTask(String jID)
        {
            String query = String.Format("call GET_INFO_USER_IN_PROJECT_BUT_NOT_IN_JOB(@jID)");
            MySqlCommand command = new MySqlCommand(query, con);
            command.Parameters.Add("@jID", MySqlDbType.VarChar).Value = jID;
        ...
        // Get list of user not joining in a project
        public DataTable GetUserOutProject(String pjID)
        {
            String query = String.Format("call GET_INFO_USER_NOT_IN_PROJECT_LEVEL_0(@pjID)");
            MySqlCommand command = new MySqlCommand(query, con);
        ...
        // Get login user information by their email
        ...
        // Send verify email to user after their account is created
        ...
        // Get information of a specific user with userID
        ...
        // Check if user with cccd and email exist
