...
namespace CNPM_ver3
{
    public partial class PageControlPM : Form
    {
        ...
        // Show project to project manager
        ...
        // Assign task to member of project
        ...
        private void AsT_UpdateTask()
        {
            ...
            {
                MessageBox.Show("Cập nhật nhiệm vụ không thành công");
            }
        ...
        // Delele resource file , project manager's funtion 
        ...
        // Download file when double click in cell of datagridview 
        ...
        // Download file when double click to file in datagrid view
...
/*            AsT_dataGridView_assignees.Columns.Add("No.", "STT");
        ...
        // Get information of current task in to cell in datagridcview when double click
        ...
        // Validate name of project is null
        ...
        // Switch option : have deadline or doesn't have
        ...
        // Add user from not in project to in project 
        ...
        // RM
        // Check if type of request is selected
        ...
        // See the content of request when click to request in datagridview
        ...
        // Download file when click to file in datagrid view
        ...
        // Get project of user when PM see this user
        ...
        // Get next page of paging project
        ...
        // Get previous page of paging project
        ...
        // Switch to get sended or received notification
        ...
        // Get information of notification when click to it in datagridview
        ...
        */
        ...
        // Check the start day of task is before end day
        ...
        // Set up the view of week in timeline function
        ...
        // Get the length of task by date
        ...
        // Check if project in current week
        ...
        // Highlight project base on the hl value 
        ...
        // View timeline of task in another week
        ...
        // Close timeline page
        private void bunifuButton_close_Click_1(object sender, EventArgs e)
        {
            PD_dataGridView_taskTimeLine.Columns.Clear();
            PD_dataGridView_task.Columns.Clear();
            pages.SetPage(2);
